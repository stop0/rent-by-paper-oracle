    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-950 dark:bg-black dark:text-zinc-50">
      <main className="mx-auto flex max-w-5xl flex-col gap-6 px-6 py-16">
        <header className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Manager</p>
        ...
        <section className="grid gap-4 sm:grid-cols-3">
          {[
            { label: "Assigned properties", value: "—" },
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
          ...
          <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-300">
            Next: show assigned properties via `property_managers` and RLS.
          </p>
        </section>
      </main>
    </div>
